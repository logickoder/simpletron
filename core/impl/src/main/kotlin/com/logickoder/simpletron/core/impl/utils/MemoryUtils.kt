 ...
 * */
fun com.logickoder.simpletron.core.component.Memory.separator() = 10.0.pow(log10(maxWord.toDouble()).toInt() - 1).toInt()

/**
 * returns the value that should be used to cancel [Input] when received as an [Instruction]
 * */
fun com.logickoder.simpletron.core.component.Memory.stopValue() =
    Math.negateExact(10.0.pow(log10(minWord.absoluteValue.toDouble()).toInt() + 2).toInt() - 1).toFloat()

/**
 * Displays the memory dump in hex
 * */
fun com.logickoder.simpletron.core.component.Memory.dump(display: com.logickoder.simpletron.core.component.Display) = with(display) {
