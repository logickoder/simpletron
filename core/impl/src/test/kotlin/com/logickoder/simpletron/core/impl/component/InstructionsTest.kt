...
class InstructionsTest {
    ...
    companion object {
        ...
        private fun mockInput(input: String = "") = mock<com.logickoder.simpletron.core.component.Input>{
            on { read() } doReturn input
        }
        private inline fun <reified T: com.logickoder.simpletron.core.component.Instruction> instruction(cpu: com.logickoder.simpletron.core.component.CPU, memLocation: Int, operand: Int = MEM_LOCATION) {
